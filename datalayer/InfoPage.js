...
module.exports = {
    ...
    getFaqPageData(_this) {
        DB.infopage.get_all(function(result){
            ...
            var initText = {text: `<h3>The standard Lorem Ipsum passage, used since the 1500s</h3>
            ...
            //console.log(result);
            _this.setState({count: result.totalrows, dataObj: result, htmlText: initText.text, htmlImage: initText.image});
        })
    },
    ...
    getTermPageData(_this) {
        DB.infopage.get_all(function(result){
            ...
            var initText = {text: `<p>Hello, and welcome to our Terms and Conditions of Use. This is important and affects your legal rights, so please read them and our Privacy Policy and other terms referenced in this document carefully. We hope you’re sitting comfortably and listening to some great music. Here we go…</p>
    ...
    initDB() {
        ...
        This would fire when the app loads for the first time.
        For now we will insert dummy text from a hand coded JSON string.
        */
        ...
        <p>If you are a resident of one of the following countries, reference this chart for your country-specific age restrictions:</p>`,
        image: require("../img/background2.png")};
